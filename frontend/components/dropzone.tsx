            ...
            <div className="flex items-center gap-2">
                ...
                <HelpTooltip>
                    <Balancer>
                        ...
                        <p>
                            It will automatically process the files and stop at its current pipeline when it encouters an error.
                        </p>
                    </Balancer>
                </HelpTooltip>
            </div>
            <div className="border border-dashed rounded-xl border-slate-300 bg-slate-50 px-16 py-10 text-slate-600 cursor-pointer"
                {...getRootProps()}
            >
